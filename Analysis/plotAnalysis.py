...
for path in sorted(glob.glob("results/test02_300gen/*/f.npy")):
    f = np.load(path)
...
# f_all = np.load("results/smoke_test12/299/f.npy")   # shape (pop, 3)
# x_all = np.load("results/smoke_test12/299/x.npy")   # shape (pop, n_params)
